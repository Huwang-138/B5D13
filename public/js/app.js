...
function handleNotificationClick(n) {
  ...
  if (n.message.includes('khiếu nại') && state.user?.role === 'admin') {
    API.delete(`/api/notifications/${n._id}`).then(() => fetchNotifications()).catch(console.error);
  }
  ...
  try {
    ...
    list.forEach(v => {
      ...
      const actionBtn = isAdmin
        ? `<div style="cursor:pointer;opacity:0.7;display:inline-flex;align-items:center;justify-content:center;" onmouseover="this.style.opacity='1'" onmouseout="this.style.opacity='0.7'" title="Xóa lỗi" onclick="deleteViolation('${v._id}');event.stopPropagation();"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--rose)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"></path><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"></path><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"></path></svg></div>`
        : `<div style="cursor:pointer;opacity:0.7;display:inline-flex;align-items:center;justify-content:center;" onmouseover="this.style.opacity='1'" onmouseout="this.style.opacity='0.7'" title="Khiếu nại" onclick="appealViolation('${v._id}');event.stopPropagation();"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--cyan)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg></div>`;
